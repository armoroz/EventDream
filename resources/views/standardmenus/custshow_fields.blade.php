        ...
        <div class="carousel-details-wrapper" style="display: flex; flex-wrap: wrap;">
            ...
            <div class="standardmenu-details" style="margin-left: -30px;">
				...
				<div>
				    ...
				    <button id="addItem" type="button" class="btn btn-primary addItem" value="{{$standardmenu->id}}">Add to Cart<i class='far fa-shopping-cart' style='font-size: 1.em; margin-left: 3px;'></i></button>
				</div>
            </div>
        </div>
    </div>
