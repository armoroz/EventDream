        ...
        <div class="carousel-details-wrapper" style="display: flex; flex-wrap: wrap;">
            ...
            <div class="standardmenu-details" style="margin-left: -30px;">
				...
				<div>
				    ...
				    <button id="addItem" type="button" class="btn btn-primary addItem" value="{{$standardmenu->id}}"><span class="text">Add to Cart<i class='far fa-shopping-cart' style='font-size: 1.em; margin-left: 3px;'></i></span></button>
